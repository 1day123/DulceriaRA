...
<head>
  ...
  <title>RegistrarRepartidores</title>
</head>
  ...
  <div class="container-fluid" id="fondoregistrar">
    ...
    <div class="row" id="contenedorregistrar"><!-- contenedor para el registro -->
      <section id="registropr">
        ...
        <form id="datos" action="../Servidor/RegistrarRepartidoresBD.php" method="POST"><!-- formulario para el registro -->
          <img src="img/usuario.png" alt="" id="imagenusuariologin">
          <div class="row">
            <h1 id="titulois">Registrar Repartidores</h1>
            ...
            <div class="col-6">
              ...
              <input class="inputis" value="4" name="tipo_usuario" type="hidden" placeholder="tipodeusuario">
              <br>
